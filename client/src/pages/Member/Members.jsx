        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-gray-100">
              ...
              <tr className="hover:bg-gray-50 transition">
                ...
                <td className="px-6 py-4 text-blue-600 cursor-pointer hover:underline text-sm font-bold">
          ...
          <div className="p-4 border-t border-gray-100 flex items-center justify-between bg-gray-50">
            ...
            <div className="flex gap-2">
              <button className="px-4 py-1 border border-gray-300 rounded bg-white text-sm hover:bg-gray-50 disabled:opacity-50">
                Prev
              </button>
              <button className="px-4 py-1 border border-gray-300 rounded bg-white text-sm hover:bg-gray-50 font-bold">
                Next
              </button>
            </div>
          </div>
